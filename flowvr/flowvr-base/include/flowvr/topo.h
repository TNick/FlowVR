...
namespace flowvr
{
	...
	/**
	 * helper class to abbreviate use of libtopology and some common
	...
	public:
		...
		topo_cpuset_t getSystemCPUMask() const;
		...
		std::deque<topo_cpuset_t> getL2GroupSet() const;
		std::deque<topo_cpuset_t> getL3GroupSet() const;
		std::deque<topo_cpuset_t> getSocketGroupSet() const;
		...
		struct _topology
		{
			topo_topology_t    t_topology;
			topo_topology_info t_topology_info;
		} topology;
