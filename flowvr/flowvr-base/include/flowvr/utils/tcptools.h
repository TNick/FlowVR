...
namespace flowvr
{
	namespace utils
	{
		...
		public:
			...
			{
			public:
				CreateSocketException( const char *where, int errno )
				: TcpException( "CreateSocketException", where, "Could not create TCP socket", errno )
				{
				}
			...
			{
			public:
				ConnectException( const char *where, int errno, sockaddr_in &addr )
				: TcpException("ConnectException", where, "Failed to connect", errno, &addr )
				{
			...
			{
			public:
				SetOptionException( const char *where, const char *what, int errno )
				: TcpException("SetOptionException", where, what, errno ) {}
			};
			...
			{
			public:
				BindSocketException( const char *where, int errno )
				: TcpException( "BindSocketException", where, "failed to bind socket.", errno ) {}
			};
			...
			{
			public:
				SetListenStateException( const char *where, int errno )
				: TcpException( "SetListenStateException", where, "failed to set listen state on server socket", errno ) {}
			};
			...
			{
			public:
				AcceptException( const char *where, int errno )
				: TcpException( "AcceptException", where, "failed during accept.", errno ) {}
			};
			...
			{
			public:
				ReceiveException( const char *where, int errno )
				: TcpException( "ReceiveException", where, "failed during receiving of data.", errno ) {}
			};
			...
			{
			public:
				SendException( const char *where, int _errno )
				: TcpException( "SendException", where, "failed to write data", _errno ) {}
			};
