...
class Parser
{
  ...
  xml::DOMElement* filelist;
  xml::DOMElement* hostlist;
  xml::DOMElement* objectlist;
  xml::DOMElement* tracelist;
  xml::DOMElement* eventlist;
  xml::DOMElement* linklist;
...
private:
  ...
  Match* ParseMatch(xml::DOMElement* match); // 6'
  Link* ParseLink(xml::DOMElement* link); // 7'
  void ParseLinkList(); // 8'
  Event* ParseEvent(xml::DOMElement* event); // 7
  void ParseEventList(); // 8
  Trace* ParseTrace(xml::DOMElement* trace); // 9
  void ParseTraceList(); // 10
  Object* ParseObject(xml::DOMElement* object, int lastpos); // 11
  void ParseObjectList(); // 12
  Host* ParseHost(xml::DOMElement* host); // 13
  void ParseHostList(); // 14
  void ParseFileList(); // 15
  Display* ParseDisplay(xml::DOMElement* drawdesc, int type); // 16
