...
public:
  ...
  Display_Object(xml::DOMElement* draw);
...
public:
  ...
  Display_Event(xml::DOMElement* draw);
...
//   virtual xml::DOMElement xmlDesc();
  ...
  Display_Link(xml::DOMElement* draw);
...
public:
  ...
  Display_Object_Line(xml::DOMElement* draw);
...
public:
  ...
  Display_Object_Text(xml::DOMElement* draw);
...
public:
  ...
  Display_Event_Line(xml::DOMElement* draw);
...
class Display_Link_Line: public Display_Link
{
  ...
  virtual void draw(ShotInfo &shot_src, ShotInfo &shot_dest);
  virtual xml::DOMElement xmlDesc();
  Display_Link_Line(xml::DOMElement* draw);
...
class Display_Link_ObjLine: public Display_Link
{
  ...
  Display_Link_ObjLine(xml::DOMElement* draw);
