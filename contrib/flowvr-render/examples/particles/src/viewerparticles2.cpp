...
int main(int argc, char** argv)
{
  ...
  // Load texture
  scene.loadTexture(idTexture,"images/goutte.png");
...
//  scene.addParamEnum(idPrim, ChunkPrimParam::PARAMVSHADER, "ModelViewIT", ChunkPrimParam::ModelView_InvTrans);
  scene.addParam(idPrim, ChunkPrimParam::PARAMVSHADER, "size", 100.0f);
  scene.addParamID(idPrim, ChunkPrimParam::TEXTURE, "texture", idTexture);
  scene.addParam(idPrim,ChunkPrimParam::ORDER,"",10);
  scene.addParamEnum(idPrim,ChunkPrimParam::PARAMOPENGL,"Blend",true);
  //scene.addParamEnum(idPrim,ChunkPrimParam::PARAMOPENGL,"BlendMode",BLEND_ADD);
  scene.addParamEnum(idPrim,ChunkPrimParam::PARAMOPENGL,"DepthWrite",false);
